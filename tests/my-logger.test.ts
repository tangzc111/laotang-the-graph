...
import { handleDataStored } from "../src/my-logger"
import { createDataStoredEvent } from "./my-logger-utils"
...
describe("Describe entity assertions", () => {
  beforeAll(() => {
    ...
    let newDataStoredEvent = createDataStoredEvent(sender, message, timestamp)
